...
from .views import (
    ...
    # USERS (Funções importadas)
    user_list_view,          # A view que lista
    user_edit,               # A view que edita perfil (nome/email)
    admin_delete_user,       # A view que deleta
    admin_edit_user_permissions, # A view que edita as permissões (checkboxes)
...
urlpatterns = [
    ...
    path('register/', register, name='register'), # Registro público (opcional)
    path('criar-conta/', criar_conta, name='criar_conta'), # Outra forma de registro/criação
    ...
    path('admin-area/users/edit/<int:user_id>/', user_edit, name='admin_user_edit'), # Nome padronizado
    ...
    # CRUD POSTS
    # --------------------
    path('admin-area/posts/', AdminPostListView.as_view(), name='admin_post_list'), # Nome padronizado
    ...
    path('admin-area/tags/create/', tag_create, name='admin_tag_create'), # Uso de 'create' em vez de 'add' para padronização
    ...
    # CRUD PROJETOS (ADMIN)
    # --------------------
    path('admin-area/projects/', AdminProjectListView.as_view(), name='admin_project_list'), # Nome padronizado
